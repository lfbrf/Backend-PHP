...
$(document).ready(function() {
    $("#postal_code").mask("99999-999",{completed:function(){
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('postal_code') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="postal_code" type="postal_code" class="form-control" name="postal_code" value="{{ old('postal_code') }}" required placeholder="99999-999">
                        ...
                        <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('complement') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="complement" type="complement" class="form-control" name="complement" value="{{ old('complement') }}" required>
                         ...
                         <div class="form-group{{ $errors->has('district') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="district" type="district" class="form-control" name="district" value="{{ old('district') }}" required>
